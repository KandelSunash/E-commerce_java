    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form id="form-valid" class="form-horizontal" method="post" enctype="multipart/form-data" action="${pageContext.servletContext.contextPath}/product/_addproduct">
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" rows="3" name="long_description"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="category" data-rel="chosen" name="catey">
                                ...
                                <c:forEach items="${list}" var="x">
                                    <option value="${x.id}" onchange="setsubcategory('${x.id}')">${x.category_name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                            ...
                            <select data-rel="chosen" name="sub_catey">
                                ...
                                <c:forEach items="${list}" var="x">
                                    <c:forEach items="${x.sub_category}" var="y"> 
                                        <option value="${y.id}" class="sub_category ${y.category.id}">${y.sub_name}</option>
                                    </c:forEach>
                                </c:forEach>
                            </select>
                        </div>
...
<!--                <script>
            ...
            <%--<c:forEach items="" var="x">--%>
                var man="<option>".\\${x.manufacture_name}
            <%--</c:forEach>--%>
                    $('#category').change(fuction(){
