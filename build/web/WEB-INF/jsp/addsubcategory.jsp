			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
                                            <form id="form-valid" class="form-horizontal" method="post" action="${pageContext.servletContext.contextPath}/category/addsubcategory">
                                                    
							<div class="control-group">
							  <label class="control-label" for="category_name">Sub Category Name</label>
							  <div class="controls">
								<input type="text" id="name" name="sub_name">
							  </div>
							</div>  
                                                        <div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Sub Category Description</label>
							  <div class="controls">
                                                                <textarea class="cleditor" id="textarea2" rows="3" name="sub_description"></textarea>
							  </div>
							</div>
                                                        <div class="control-group">
