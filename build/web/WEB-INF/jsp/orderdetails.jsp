                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>                                                     
                        <c:forEach items="${odlist}" var="x">
                            <tr>
                                <td><%= id++%></td>
                                <td class="center">${x.product.product_name}</td>
                                <td class="center">${x.product_sales_quantity}</td>
                                <td class="center">Rs. ${x.product_price}</td>
                                <td class="center">${x.order.order_date_time}</td>
                                <td class="center">${x.order.customer.first_name} ${x.order.customer.last_name} </td>
                                <td class="center">${x.order.shipping.shipping_address}</td>
                                <td class="center">
