            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/cpanel/_changepassword" method="post">
                            <fieldset>
                                <div class="input-prepend" title="Email">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" name="password" id="password" onkeyup='check();' type="password" placeholder="type pasword"/>
                                </div>
                                <div class="clearfix"></div>
                                <div class="input-prepend" title="Email">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" name="Confirm_password" onkeyup='check();' id="confirm_password" type="password" placeholder="retype pasword"/>
