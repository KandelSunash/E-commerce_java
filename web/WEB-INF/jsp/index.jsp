            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <form class="form-horizontal" action="${pageContext.servletContext.contextPath}/cpanel/adminlogin" method="post">
                            <fieldset>
                        ...
                        <p>
                            No problem, <a href="${pageContext.servletContext.contextPath}/cpanel/forgotpassword">click here</a> to get a new password.
                        </p>	
                    </div><!--/span-->
                </div><!--/row-->
