                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="${pageContext.servletContext.contextPath}/resources/images/product/${product.product_image}">
                                <div class="thumb-image"> <img src="${pageContext.servletContext.contextPath}/resources/images/product/${product.product_image}" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li> 
                        </ul>
                    </div>
                </div>
