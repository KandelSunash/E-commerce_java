    ...
    <div class="container">
        <div class="col-md-9 product-w3ls-right">
            ...
            <div class="products-row">
                <c:forEach items="${prlist}" var="x">
                <div class="col-md-3 product-grids"> 
                    <div class="agile-products">
                        <!--<div class="new-tag"><h6>20%<br>Off</h6></div>-->
                        <a href="${pageContext.servletContext.contextPath}/product/productdetails?id=${x.id}"><img src="${pageContext.servletContext.contextPath}/resources/images/product/${x.product_image}" class="img-responsive" alt="img"></a>
                        <div class="agile-product-text">              
                            <h5><a href="${pageContext.servletContext.contextPath}/product/productdetails?id=${x.id}">${x.product_name}</a></h5> 
                            <!--<h6><del>$200</del> $100</h6>--> 
                            <form action="#" method="post">
                                <input type="hidden" name="cmd" value="_cart" />
                                <input type="hidden" name="add" value="1" /> 
                                <input type="hidden" name="w3ls_item" value="${x.product_name}" /> 
                                <input type="hidden" name="amount" value="${x.product_price}" /> 
